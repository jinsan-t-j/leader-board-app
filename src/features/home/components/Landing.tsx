  ...
  return (
    <div className="relative flex flex-col justify-center md:w-3/5">
      ...
      <h1 className="mb-16 font-light text-4xl tracking-wide text-black md:text-6xl xl:text-7xl">
        You Are A{" "}
        <span className="font-semi-bold text-6xl md:text-8xl xl:text-9xl">
          {" "}
          Star{" "}
        </span>
      </h1>
            ...
            return (
              ...
              >
                ...
                <div className="mb-4 flex flex-col justify-center rounded-2xl bg-black p-4 py-8">
                  <div className="relative lightning-container">
                    <div
                      className={`absolute bottom-0 w-full border   lightning  bg-gradient-to-t ${percentageGradient} delay-150 duration-200`}
